...
<body>
	...
	<main class="main-content">
		...
		<%
		List<Map<String, Object>> flights = (List<Map<String, Object>>) request.getAttribute("airport_flights");
		%>
		<%
				...
				<tbody>
					...
					<tr>
						...
						<td class="actions">
							...
							<form action="<%=request.getContextPath() + "/CustRep"%>/editFlight?flightId=<%=flight.get("FlightID")%>" method="get">
